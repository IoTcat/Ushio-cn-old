...
<code>rgba(0,0,0,0.3)</code>，填写后你就会发现效果的，就是让透明色不太过透明，导致字都看不清了。</br></br> 一般来说，".redText('根据背景图片的主色调来填比较好看。')." </br>举例：背景图片主色调是蓝色，那就填 <code>rgba(56, 136, 255, 0.3)</code> (56,136,255) 就是蓝色，0.3 代表背景的透明度。"));
        ...
        //博客logo
        $logo = new Text('logo', NULL,NULL, _t('博客logo的HTML结构'), _t('<strong style="color: red">填写HTML代码，填写此处将不会显示上面设置中的博客名称和图标</strong>，如果是图片请填写下面格式 <code>   <img src="https://ws2.sinaimg.cn/large/006tKfTcly1g1pcxh6so4j30bw012a9w.jpg">    </code>，也可以填写更复杂的html代码，如svg等'));
        $form->addInput($logo);
        //博客标题后缀
...
function themeFields(Typecho_Widget_Helper_Layout $layout){
    ...
    $noThumbInfoStyle = new Typecho_Widget_Helper_Form_Element_Select('noThumbInfoStyle', array(
        ...
        'design' => '设计',
        'lock' => '上锁'
    ),'default', _t('个性化标徽选择'), '该选项仅在<strong style="color: red">首页当前文章不显示头图</strong>，样式才会有效</br> 点击<a href="https://ws2.sinaimg.cn/large/006tNc79ly1fzdcymh8bsj302w0sx3yo.jpg">这里依次预览所有图标</a>');
